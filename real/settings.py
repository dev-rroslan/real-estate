...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'real.undi.online', 'shark-app-yqcoa.ondigitalocean.app']  # <-- Updated!
CSRF_TRUSTED_ORIGINS = ['https://real.undi.online', 'https://shark-app-yqcoa.ondigitalocean.app']  # <-- Updated!
